    ...
    <div class="section-1" id="section-1">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="jumbotron col-10 p-0 pb-2 m-0 mb-4 ">
                ...
                <div class="col-12 d-flex justify-content-center embed-responsive-1by1m-0 p-0">
                    <img class="embed-responsive-item" src="img/Mahen/carFront.png" style="width: 2000px; height: 25rem;">
                    <div class="card-img-overlay d-flex align-items-center justify-content-center">
                        
                        <div class="row ">
                            <div class="col-lg-12 ">
                                <button type="button" class="btn btn-success btn-lg btn-block" id="btn_newReq">New
                                    Request
                                    <i class="fas fa-pencil-alt"></i>
                                </button>
                            </div><br><br><br>
                            <div class="col-lg-12">
                                <a href="userProfile.jsp" class="btn btn-success btn-lg btn-block" id="btn_myReq">My
                                    Requests
                                    ...
                                    <div class="row row-cols-2">
                                        ...
                                        <div class="media p-3 mb-4" style="background-color: skyblue;">
                                            <div class="media-body mr-3">
                                                ...
                                                <p class="text-right">Enim est reprehenderit commodo aute magna
                                                    cillum sunt veniam esse ex esse officia.</p>
                                            </div>
                                        ...
                                        <div class="media p-3 mb-4" style="background-color: magenta;">
                                            <div class="media-body mr-3">
                                                ...
                                                <p class="text-right">Enim est reprehenderit commodo aute magna
                                                    cillum sunt veniam esse ex esse
                                                    officia.</p>
                                            </div>
                                        ...
                                        <div class="media p-3 mb-4" style="background-color: #fcff33;">
                                            ...
                                            <div class="media-body">
                                                ...
                                                Deserunt adipisicing elit dolor deserunt cillum sint veniam magna
                                                esse eu.
                                            </div>
                                        </div>
                                        ...
                                        <div class="media p-3  mb-4" style="background-color: greenyellow;">
                                            <div class="media-body mr-3">
                                        ...
                                        <div class="media p-3  mb-4" style="background-color: #ff4d4d">
                                            ...
                                            <div class="media-body">
                                                ...
                                                Consectetur sint ut amet cupidatat nulla non occaecat velit veniam
                                                velit nisi mollit adipisicing.
                                            </div>
                                        </div>
                        ...
                        <dv class="row row-cols-4  status_Display_Area  m-3" style="height: 250px;">
                            ...
                            <div class="card col-2 mr-5 ml-5 mb-0 mt-0 p-0" id="Vehicle_details_Demo">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><i class="fab fa-bootstrap"></i> Brand : Toyota</p>
                                    <p class="card-text"><i class="fab fa-maxcdn"></i> Model : CHR</p>
                                    <p class="card-text"><i class="far fa-calendar-alt"></i> Year : 2018</p>
                                    <div class="d-flex justify-content-center align-self-center">
                            ...
                            <div class="card col-2 mr-5 ml-5 mt-0 p-0" id="Time_dimo">
                                <img class="card-img-top" src="img/Mahen/clock.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Your Time</h5>
                                    <p class="card-text">
                                        <p class="card-text"><i class="far fa-calendar-alt"></i> 25-03-2020</p>
                                        <p class="card-text">
                                            <p class="card-text"><i class="far fa-clock"></i> 9.00</p>
                                            <div class="d-flex justify-content-center align-self-center">
                ...
                <div class="mah" id="mah1">
                    <div class="row row-cols-3 d-flex justify-content-center pack_select">
                        ...
                        <div class="card col-3 m-3 p-0" id="pcg_card">
                            <img class="card-img-top" src="img/Mahen/car_exterior_card.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card col-3 m-3 p-0" id="pcg_card">
                            <img class="card-img-top" src="img/Mahen/Hybrid_dard.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card col-3 m-3 p-0" id="pcg_card">
                            <img class="card-img-top" src="img/Mahen/Wheel-alignment-card.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card col-3 m-3 p-0" id="pcg_card">
                            <img class="card-img-top" src="img/Mahen/Engine_tine_up_card.png" alt="Card image cap">
                            <div class="card-body">
...
<!--Start of  row 1 Section 4-->
                ...
                <div class="invoice">
                    <div class="jumbotron">
                        <div class="row row-cols-3 Invoice_header d-flex align-items-center">
                        ...
                        <div class="row row-cols-3 d-flex align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                <p style="font-size: 50px; color: #ff4561;">4152.00 Rs</p>
                            </div>
                        </div>


                        <hr class="my-4" style="background-color: #ff4561; height: 3px; border-radius: 3px;">
                        ...
                        <table class="table table-borderless ">
                            ...
                            <tbody>
                                <tr>
                                    <td><strong>Package charges</strong><br>Description</td>
                                    <td>2000.00</td>
                                    <td>1</td>
                                    <td>2000.00</td>
                                </tr>
                                ...
                                <tr>
                                    <td><strong>Parts</strong><br> Description</td>
                                    <td>1000.00</td>
                                    <td>1</td>
                                    <td>1000.00</td>
                                </tr>
                                Description
                                <tr>
                                    <td><strong>Service Charge</strong><br> Description</td>
                                    <td>1000.00</td>
                                    <td>1</td>
                                    <td>1000.00</td>
                                </tr>
                        ...
                        <div class="text-right d-flex justify-content-end">
                            ...
                            <div class="col-3">
                                <p><strong>4000.00 Rs</strong></p>
                                <p><strong>152.00 Rs</strong></p>
                            </div>
                        </div>
                        <hr class="my-4" style="background-color: #ff4561; height: 3px; border-radius: 3px;">
                        <div class=" d-flex justify-content-end">
                            <a class="btn btn-primary btn-lg mr-5 " href="#" role="button">Cancel <i
                                    class="far fa-window-close"></i></a>
                            <a class="btn btn-primary btn-lg mr-5 " href="#" role="button">Conferm <i
